...
using BabyMayasAdventures.Services;

namespace BabyMayasAdventures
{
    /// <summary>
    ...
    {
        private Guid APP_ID = new Guid("75469d15-6d66-4678-9694-98f53896cf3c");
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"Baby Maya's Adventures", @"Maya Himawari Sabban");
