...
{
    public sealed partial class AboutBabyMayaListPage : PageBase , INotifyPropertyChanged    {
        private DataTransferManager _dataTransferManager;

        public AboutBabyMayaListPage()
        {
            this.ViewModel = new ListViewModel<LocalStorageDataConfig, HtmlSchema>(new AboutBabyMayaConfig());
